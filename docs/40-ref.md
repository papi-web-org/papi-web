...
| `number`     | Le nombre d'échiquiers du tournoi à considérer (facultatif, doit être utilisée avec `part`).                                                                                                                                                                                                                                           |
...
> - les options `part`/`parts` ou `part`/`number` doivent toujours être utilisées ensemble ;
> - les options `first` et `last` peuvent être utilisées avec les options `part`/`parts` ou `part`/`number`, elles déterminent les numéros du premier et du dernier échiquier avant d'extraire les sous-ensembles d'échiquiers (par défaut `first` vaut 1 et `last` vaut le numéro du dernier échiquier).
