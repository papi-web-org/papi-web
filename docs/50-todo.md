...
La rupture avec le stockage actuel peut être perturbante (aujourd'hui : 1 tournoi = 1 fichier).
...
- possibilité de faire un truc portable sur Linux/Windows si on se débarrasse d'Access
- nécessité ou pas d'un Framework au dessus de Bootstrap pour l'interface web