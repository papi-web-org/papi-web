...
| `room`          | L'identifiant de la salle de jeu qui sera utilisée pour l'écran. Ne prendra en compte que les échiquiers définis dans la salle |
